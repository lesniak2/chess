 ...
 * @author tlesnia2
 *
 * A class modeled after the Rook piece in chess.
 */
public class Rook implements Piece {
	
	/**
	 * Constructs a Rook piece belonging to a certain team at a location on the board.
	 ...
	 * @see Team.java
	 */
	public Rook(Location l, Team t)
	{
		if(t != Team.WHITE && t != Team.BLACK)
		{
			throw new IllegalArgumentException("for Rook with team " + t); 
		}
		_team = t;
		this._location = l;
	}
